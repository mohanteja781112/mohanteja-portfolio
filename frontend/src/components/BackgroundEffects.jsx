...
const BackgroundEffects = () => {
  ...
  useEffect(() => {
    ...
    let numParticles = isTouchDevice || window.innerWidth < 1024 ? 0 : 60; // Disabled on touch devices and small screens
    let maxDist = isTouchDevice || window.innerWidth < 1024 ? 0 : 150;
    ...
    const resize = () => {
      ...
      const isTouchDevice = typeof window !== 'undefined' && ('ontouchstart' in window || navigator.maxTouchPoints > 0);
      numParticles = isTouchDevice || window.innerWidth < 1024 ? 0 : 60;
      maxDist = isTouchDevice || window.innerWidth < 1024 ? 0 : 150;
